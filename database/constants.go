...
const (
	...
	// BlockTime is the interval at which RA broadcasts new problems and ideally creates new blocks. 86400 sec is around one day, for debugging use sth like 45 or 90 sec
	BlockTime = 90
